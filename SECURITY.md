...
If you discover a security vulnerability in clairview, please report it responsibly through GitHub's private vulnerability reporting:

1. Go to the [Security tab](https://github.com/hpfrei/clairview/security) of this repository
...
clairview is a local development tool that proxies API traffic. Key areas of concern include:
...
When running clairview, keep in mind:
...
- API keys are forwarded to the Anthropic API but are never logged or persisted by clairview
