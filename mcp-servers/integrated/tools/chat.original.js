...
export default function register(server) {
  ...
  const body = JSON.stringify({ type: 'chat', prompt, cwd: cwd || undefined, profile: profile || undefined, sessionId: session_id || undefined, sourceInstanceId: process.env.VISTACLAIR_INSTANCE_ID || undefined });
